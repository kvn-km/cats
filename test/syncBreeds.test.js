...
describe("#breedDetails", () => {
  ...
  it("return breed details for the Balinese breed", () => {
    ...
    assert.equal(bali, expectedDesc);
  });

  it("should return an error string when the description for a breed doesn't exist", () => {
    const expectedDesc = "That breed description isn't available.";
